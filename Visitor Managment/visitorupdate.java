...
public class visitorupdate extends JFrame implements ActionListener,ItemListener {
	JLabel lbl,lblvisid,lblvisname,lblvisemail,lblvisphone,lblvisaddress,lblgender,lblidtype,lblidno;
	JTextField txtvisname,txtvisemail,txtvisphone,txtvisaddress,txtidtype,txtidno,txtgender;
	JButton btnfind,btnupdate,btnclear,btnclose;JComboBox combovisid;
	Connection con;
	...
	public visitorupdate() {
	    ...
	    JLabel image1 = new JLabel("Visitor Update",i3,SwingConstants.CENTER);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		{
			if ( txtvisname.getText().length()==0 || txtvisphone.getText().length()==0 || txtvisemail.getText().length()==0 || txtvisaddress.getText().length()==0 || txtgender.getText().length()==0|| txtidtype.getText().length()==0 || txtidno.getText().length()==0)
			{
				...
				String vna=txtvisname.getText();
				String vem=txtvisemail.getText();
				String vph=txtvisphone.getText();
				String vadd=txtvisaddress.getText();
				String gen=txtgender.getText();
				String gotp=txtidtype.getText();
				String govid=txtidno.getText();
				visitorupdatehandle obj=new visitorupdatehandle();
				String msg=obj.updatedata(vna,vem,vph,vadd,gen,gotp,govid,vid);
