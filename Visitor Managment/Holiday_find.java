...
import com.util.data.Holiday_DataFind;
...
import java.sql.*;
public class Holiday_find extends JFrame implements ItemListener{
	...
	public Holiday_find()
	{
	    ...
	    JLabel image1 = new JLabel("Holiday Find",i3,SwingConstants.CENTER);
