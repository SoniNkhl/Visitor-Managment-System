...
import java.sql.*;
public class CheckOut_DataTable extends JFrame {
	JTable jt;int i=0;int j=0;
	String cols[]= {"CHECKOUT ID","VISITOR ID","EMPLOYEE ID","HOD ID","DEPARTMENT ID","CHECKIN TIME","CHECKOUT TIME"};
	Connection con;Statement st;ResultSet rs;
	DefaultTableModel tb=new DefaultTableModel();
	
	public CheckOut_DataTable() {
	// TODO Auto-generated constructor stub
		setSize(1400,800);
		setTitle("CHECKOUT DATA TABLE");
		setVisible(true);
