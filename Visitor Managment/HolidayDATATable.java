...
import java.sql.*;
public class HolidayDATATable extends JFrame {
	JTable jt;int i=0;int j=0;
	String cols[]= {"HOLIDAY ID","HOLIDAY NAME","DATE OF HOLIDAY"};
	...
	void fillData()
	{
		try {
			...
			String sql="select * from HolidayMaster";
