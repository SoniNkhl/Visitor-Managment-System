...
import java.sql.*;
public class HODDataTable extends JFrame {
	JTable jt;int i=0;int j=0;
	String cols[]= {"HOD ID","HOD NAME","EMAIL","PHONE","ADDRESS","DEPARTMENT ID","SHIFT ID"};
	...
	void fillData()
	{
		try {
			...
			String sql="select * from headofdepartment";
