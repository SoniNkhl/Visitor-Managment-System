...
public class visitordelete extends JFrame implements ActionListener,ItemListener{
	...
	public visitordelete() {
	    ...
	    JLabel image1 = new JLabel("Visitor Delete",i3,SwingConstants.CENTER);
		...
		btndelete.setBounds(450,550,100,30);
		btndelete.setBackground(new Color(173,216,230));
		add(btndelete);	
		image.add(btndelete);
		
		btnclose=new JButton("CLOSE");
		btnclose.setBounds(750,550,100,30);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		{
			if (combovisid.getSelectedItem().toString().length()==0||txtvisname.getText().length()==0 || txtvisemail.getText().length()==0 || txtvisphone.getText().length()==0 || txtvisaddress.getText().length()==0||txtgender.getText().length()==0||txtidtype.getText().length()==0||txtidno.getText().length()==0)
			{
				...
				if(opt==0)
				{
				String viid=combovisid.getSelectedItem().toString();
				String viname=txtvisname.getText();
				String viem=txtvisemail.getText();
				String viph=txtvisphone.getText();
				String viad=txtvisaddress.getText();
				String vigen=txtgender.getText();
				String vid=txtidtype.getText();
				String vno=txtidno.getText();
				
				VisitorDeleteHandle obj=new VisitorDeleteHandle();
				String msg=obj.deleteData(viid,viname,viem,viph,viad,vigen,vid,vno);				
				JOptionPane.showMessageDialog(this, msg);
				combovisid.getSelectedItem().toString();
				txtvisname.setText("");
				txtvisemail.setText("");
				txtvisphone.setText("");
